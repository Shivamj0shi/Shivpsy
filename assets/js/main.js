...
sr.reveal(
  `.about_img, .ps5_controller-div, .ps4_controller-div, .squid_controller-div,#cart `,
  {
    origin: 'left',
  }
);
...
sr.reveal(`.functions_title, .functions_subtitle`, { delay: 30 });
...
sr.reveal(`.faqs_title-center`, { delay: 30 });
...
sr.reveal(
  ...
  .form_name, .form_email, .form_mensage, .button_form, .form_state, .form_city,
   .form_neighborhood, .form_place, .form_cep, .form_number, .form_cpf,
    .form_name-2, .form_last-name,#sm-banner`,
  {
    origin: 'top',
  }
);
